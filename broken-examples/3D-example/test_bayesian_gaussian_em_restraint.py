...
if init:
    ...
    #    os.remove(f)
    generate_data(ngauss,"./input/1WCM.pdb",["C","K"],outputdir='./input/bayesian_em_restraint/gmm_data/')
    exit()
...
domains=   [
    ("chainC",  "chainC",    0.0,  fastadirectory+"/1WCM.fasta.txt",  "1WCM:C", pdbdirectory+"/1WCM.pdb" ,   "C",   (3,268,0),  True,        10,      0,         [1],     15,   './input/bayesian_em_restraint/C.txt',  './input/bayesian_em_restraint/C.mrc',   None),
    ("chainK",  "chainK",    0.10,  fastadirectory+"/1WCM.fasta.txt",  "1WCM:K", pdbdirectory+"/1WCM.pdb" ,   "K",   (1,114,0),  True,        10,      1,         [1],    5,   './input/bayesian_em_restraint/K.txt',  './input/bayesian_em_restraint/K.mrc',   None),
    ]
