...
conda create --yes -q -n python${python_version} -c salilab -c conda-forge python=${python_version} pip scipy imp-nightly libboost-devel gxx_linux-64 eigen cereal swig cmake
